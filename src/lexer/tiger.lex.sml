...
fun yyAction8 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (print("num: " ^ yytext); (case asciiToString(valOf (Int.fromString(String.substring(yytext, 1, 3)))) of NONE => (ErrorMsg.error yypos ("illegal ascii in string"))
...
fun yyAction12 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; print("leaving quote"); inStr := 0; Tokens.STRING(!str, !strStart, yypos+1)))
       ...
       of NONE => yyAction31(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction31(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ59(strm', yyMATCH(strm, yyAction31, yyNO_MATCH))
              else yyAction31(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ40 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ103(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
...
fun yyQ38 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ105(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
...
fun yyQ2 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"A"
              then yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"A"
              then if inp = #")"
                  then yyQ28(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp < #")"
                  then if inp = #" "
                      then yyQ23(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp < #" "
                      then if inp = #"\v"
                          then yyQ22(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                        else if inp < #"\v"
                          then if inp = #"\t"
                              then yyQ23(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                            else if inp = #"\n"
                              then yyQ24(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                              else yyQ22(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                        else if inp = #"\r"
                          then yyQ23(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                          else yyQ22(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #"&"
                  ...
                  then yyQ35(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp < #"0"
                  then if inp = #"-"
                      then yyQ32(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp < #"-"
                      then if inp = #"+"
                          then yyQ30(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                        else if inp = #"*"
                          then yyQ29(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                          else yyQ31(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #"."
                      then yyQ33(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                      else yyQ34(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #"<"
                  then yyQ38(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp < #"<"
                  then if inp = #":"
                      then yyQ36(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #";"
                      then yyQ37(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                      else yyQ35(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #">"
                  then yyQ40(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #"="
                  then yyQ39(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyQ22(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"l"
              then yyQ50(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"c"
                  then yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp < #"c"
                  then if inp = #"]"
                      then yyQ43(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp < #"]"
                      then if inp = #"["
                          then yyQ42(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                        else if inp = #"\\"
                          then yyQ22(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                          else yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #"a"
                      then yyQ44(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #"b"
                      then yyQ45(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                      else yyQ22(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #"g"
                  then yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp < #"g"
                  then if inp = #"e"
                      then yyQ47(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #"d"
                      then yyQ46(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                      else yyQ48(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #"i"
                  then yyQ49(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"v"
              ...
              then if inp = #"p"
                  ...
                  then if inp = #"n"
                      then yyQ51(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                    else if inp = #"m"
                      then yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                      else yyQ52(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #"t"
                  then yyQ53(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"|"
              ...
              then if inp = #"x"
                  ...
                  then yyQ55(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp = #"{"
                  then yyQ56(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                  else yyQ41(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"}"
            ...
            if inp = #"#"
              ...
              then if inp = #"\^N"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction13(strm, yyNO_MATCH)
                          else yyQ6(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                    else if inp = #"\r"
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction13(strm, yyNO_MATCH)
                      else yyQ8(strm', yyMATCH(strm, yyAction13, yyNO_MATCH))
                else if inp = #"\\"
