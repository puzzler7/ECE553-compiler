...
fun yyAction16 (strm, lastMatch : yymatch) = (yystrm := strm;
      (print("caught bad backslash"); (ErrorMsg.error yypos ("illegal escape in string")); continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ63(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
       ...
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ101(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
              else yyAction35(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ105(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
              else yyAction35(strm, yyNO_MATCH)
      (* end case *))
            ...
            if inp = #"A"
              ...
              then if inp = #")"
                  ...
                  then if inp = #" "
                      ...
                      then yyQ26(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                      else yyQ31(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp = #"0"
                  ...
                  then if inp = #"-"
                      ...
                      then if inp = #"+"
                          ...
                          else yyQ35(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                    else if inp = #"."
              ...
              then if inp = #"c"
                  ...
                  then if inp = #"e"
                      ...
                      else yyQ52(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp = #"i"
              ...
              then if inp = #"p"
                  ...
                  then if inp = #"n"
                      ...
                      then yyQ45(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                      else yyQ56(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp = #"t"
            ...
            if inp = #"#"
              ...
              then if inp = #"\^N"
                  ...
                  then if inp = #"\v"
                      ...
                      then if inp <= #"\b"
                          then yyAction16(strm, yyNO_MATCH)
                          else yyQ9(strm', yyMATCH(strm, yyAction16, yyNO_MATCH))
                    else if inp = #"\r"
